...
public class ResponsiveScrollRect : ScrollRect, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private void Update()
    {
        ...
        {
            var delta = UnityEngine.InputSystem.Mouse.current.scroll.value;
    ...
    {
        return UnityEngine.InputSystem.Mouse.current.scroll.value.magnitude != 0;
    }
}