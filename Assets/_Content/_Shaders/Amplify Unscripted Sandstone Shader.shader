...
Shader "Amplify Unscripted Sandstone Shader"
{
	Properties
	{
		...
		_LocalAlbedoOpacity("Local Albedo Opacity", Range( 0 , 1)) = 0.3
		_DetailNormalStrength("Detail Normal Strength", Range( -2 , 2)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode25 = tex2D( _BaseMap, uv_BaseMap );
				float4 blendOpSrc21 = tex2DNode25;
				float4 blendOpDest21 = ( _LocalTint * saturate( ( _LocalContrast + tex2DNode25.r ) ) );
				float2 uv_DetailMap = packedInput.ase_texcoord6.xy * _DetailMap_ST.xy + _DetailMap_ST.zw;
				float4 temp_cast_0 = ((saturate( ( -_LocalAlbedoOpacity + 0.5 ) ) + (tex2D( _DetailMap, uv_DetailMap ).r - 0.0) * (saturate( ( _LocalAlbedoOpacity + 0.5 ) ) - saturate( ( -_LocalAlbedoOpacity + 0.5 ) )) / (1.0 - 0.0))).xxxx;
				float4 blendOpSrc1 = ( saturate( 2.0f*blendOpDest21*blendOpSrc21 + blendOpDest21*blendOpDest21*(1.0f - 2.0f*blendOpSrc21) ));
				float4 blendOpDest1 = temp_cast_0;
				...
				float3 unpack18 = UnpackNormalScale( tex2D( _DetailNormals, uv_DetailNormals ), ( tex2DNode11.b * _DetailNormalStrength ) );
				unpack18.z = lerp( 1, unpack18.z, saturate(( tex2DNode11.b * _DetailNormalStrength )) );
				
				surfaceDescription.BaseColor = ( saturate( (( blendOpDest1 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest1 ) * ( 1.0 - blendOpSrc1 ) ) : ( 2.0 * blendOpDest1 * blendOpSrc1 ) ) )).rgb;
				surfaceDescription.Normal = BlendNormal( UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f ) , unpack18 );
				...
				surfaceDescription.Smoothness = ( tex2DNode11.a * _LocalSmooth );
				surfaceDescription.Occlusion = saturate( ( tex2DNode11.b + _AmbientOcclusionRemapping ) );
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.SamplerNode;25;-1515.656,-501.1514;Inherit;True;Property;_BaseMap;Base Map;0;0;Create;True;0;0;0;False;0;False;-1;None;469287a134d34e64a8daa864f402b1e6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.NegateNode;2;-1517.886,-127.484;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;24;-1194.372,-601.1112;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;3;-1486.7,-41.35106;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;5;-1351.699,-151.9485;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-1498.673,91.81757;Inherit;True;Property;_MaskMap;Mask Map;2;0;Create;True;0;0;0;False;0;False;-1;None;987fdc30ff941464daf158ba9d6f078f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SaturateNode;23;-1074.372,-594.7112;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;4;-1349.797,-36.97425;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;6;-1214.796,-147.5717;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-1054.391,561.5733;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-927.1731,-644.312;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCRemapNode;7;-687.2848,-87.03056;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;9;-884.7175,299.6773;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-1518.506,430.1566;Inherit;True;Property;_NormalMap;Normal Map;1;0;Create;True;0;0;0;False;0;False;-1;None;ac712703fa34a1043b72947feba0e347;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.BlendOpsNode;21;-746.489,-504.9069;Inherit;False;SoftLight;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;1;-306.6318,-160.7399;Inherit;False;Overlay;True;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;8;-746.7391,304.7589;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-444.4864,129.9589;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BlendNormalsNode;17;-527.322,398.3373;Inherit;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-663.6788,213.898;Inherit;False;Property;_LocalSmooth;Local Smooth;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1510.671,354.0095;Inherit;False;Property;_AmbientOcclusionRemapping;Ambient Occlusion Remapping;4;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1508.841,632.5622;Inherit;False;Property;_DetailNormalStrength;Detail Normal Strength;7;0;Create;True;0;0;0;False;0;False;1;0;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-1467.972,-673.1115;Inherit;False;Property;_LocalContrast;Local Contrast;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;27;-1273.855,-819.9088;Inherit;False;Property;_LocalTint;Local Tint;8;0;Create;True;0;0;0;False;0;False;0.4811321,0.4811321,0.4811321,0;0.4811321,0.4811321,0.4811321,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;18;-876.8967,498.8999;Inherit;True;Property;_DetailNormals;Detail Normals;5;0;Create;True;0;0;0;False;0;False;-1;4e92277bd12e548419f9ce2417d1a10e;4e92277bd12e548419f9ce2417d1a10e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;29;-1025.216,-313.8304;Inherit;True;Property;_DetailMap;Detail Map;3;0;Create;True;0;0;0;False;0;False;-1;d9570d4206b45314ba84dd09a8449e3c;d9570d4206b45314ba84dd09a8449e3c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;15;-1856,-96;Inherit;False;Property;_LocalAlbedoOpacity;Local Albedo Opacity;6;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
...
WireConnection;31;7;10;0
WireConnection;31;8;8;0
ASEEND*/
//CHKSM=CB4E17C96B11A2690DDA7868F14C6CC35917EDD9