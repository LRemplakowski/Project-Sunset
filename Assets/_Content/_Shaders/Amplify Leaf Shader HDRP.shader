...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		[DiffusionProfile]_DiffusionProfile("Diffusion Profile", Float) = 2.1542067527770996[HideInInspector]_DiffusionProfile_Asset("Diffusion Profile", Vector) = ( -0.000000088905473205613816, 0.0000000000000000734902130126735, 0.00000000000000000032000746031987433, 0.000000000024188795064161717 )
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _MovementFadeEnd;
			float _MovementFadeStart;
			float _Roughness;
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float mulTime13 = _TimeParameters.x * _WindFrequency;
				float2 temp_cast_0 = (mulTime13).xx;
				float2 texCoord14 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D16 = snoise( texCoord14*_NoiseScale );
				simplePerlin2D16 = simplePerlin2D16*0.5 + 0.5;
				float temp_output_22_0 = ( ( -0.5 + simplePerlin2D16 ) * _MovementMultiplier );
				float simplePerlin2D17 = snoise( texCoord14*_NoiseScale );
				simplePerlin2D17 = simplePerlin2D17*0.5 + 0.5;
				float temp_output_21_0 = ( _MovementMultiplier * ( -0.5 + simplePerlin2D17 ) );
				float3 appendResult26 = (float3(temp_output_22_0 , temp_output_21_0 , ( ( temp_output_22_0 + temp_output_21_0 ) * 0.4 )));
				float3 customSurfaceDepth40 = inputMesh.positionOS;
				float customEye40 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth40)).z;
				float cameraDepthFade40 = (( customEye40 -_ProjectionParams.y - _MovementFadeStart ) / _MovementFadeEnd);
				...
				#endif
				float3 vertexValue = ( inputMesh.uv1.y * appendResult26 * ( 1.0 - saturate( cameraDepthFade40 ) ) );
						...
						)
			{
				...
				float2 uv_ColorTexture = packedInput.ase_texcoord6.xy * _ColorTexture_ST.xy + _ColorTexture_ST.zw;
				float4 tex2DNode31 = tex2D( _ColorTexture, uv_ColorTexture );
				
				float2 uv_NormalTexture = packedInput.ase_texcoord6.xy * _NormalTexture_ST.xy + _NormalTexture_ST.zw;
				
				float2 uv_MaskTexture = packedInput.ase_texcoord6.xy * _MaskTexture_ST.xy + _MaskTexture_ST.zw;
				float4 tex2DNode28 = tex2D( _MaskTexture, uv_MaskTexture );
				
				surfaceDescription.BaseColor = ( _Tint * tex2DNode31 ).rgb;
				...
				surfaceDescription.Occlusion = tex2DNode28.g;
				surfaceDescription.Alpha = tex2DNode31.a;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = tex2DNode28.b;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float mulTime13 = _TimeParameters.x * _WindFrequency;
				float2 temp_cast_0 = (mulTime13).xx;
				float2 texCoord14 = inputMesh.uv0.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D16 = snoise( texCoord14*_NoiseScale );
				simplePerlin2D16 = simplePerlin2D16*0.5 + 0.5;
				float temp_output_22_0 = ( ( -0.5 + simplePerlin2D16 ) * _MovementMultiplier );
				float simplePerlin2D17 = snoise( texCoord14*_NoiseScale );
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ColorTexture = packedInput.ase_texcoord2.xy * _ColorTexture_ST.xy + _ColorTexture_ST.zw;
				float4 tex2DNode31 = tex2D( _ColorTexture, uv_ColorTexture );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 defaultVertexValue = float3( 0, 0, 0 );
				#endif
				float3 vertexValue = ( inputMesh.ase_texcoord1.y * appendResult26 * ( 1.0 - saturate( cameraDepthFade40 ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_NormalTexture = packedInput.ase_texcoord4.xy * _NormalTexture_ST.xy + _NormalTexture_ST.zw;
				
				float2 uv_ColorTexture = packedInput.ase_texcoord4.xy * _ColorTexture_ST.xy + _ColorTexture_ST.zw;
				float4 tex2DNode31 = tex2D( _ColorTexture, uv_ColorTexture );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ColorTexture = packedInput.ase_texcoord8.xy * _ColorTexture_ST.xy + _ColorTexture_ST.zw;
				float4 tex2DNode31 = tex2D( _ColorTexture, uv_ColorTexture );
				
				float2 uv_NormalTexture = packedInput.ase_texcoord8.xy * _NormalTexture_ST.xy + _NormalTexture_ST.zw;
				
				float2 uv_MaskTexture = packedInput.ase_texcoord8.xy * _MaskTexture_ST.xy + _MaskTexture_ST.zw;
				float4 tex2DNode28 = tex2D( _MaskTexture, uv_MaskTexture );
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.RangedFloatNode;12;-2006.354,726.9171;Inherit;False;Property;_WindFrequency;Wind Frequency;5;0;Create;True;0;0;0;False;0;False;1.34;0.83;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;13;-1803.819,730.0842;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1588.628,680.918;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-1537.092,871.2047;Inherit;False;Property;_NoiseScale;Noise Scale;7;0;Create;True;0;0;0;False;0;False;1.41;1.41;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;16;-1303.197,682.9003;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;17;-1305.179,847.4189;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1136.696,780.0258;Inherit;False;Property;_MovementMultiplier;Movement Multiplier;8;0;Create;True;0;0;0;False;0;False;0.07;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-1047.499,678.936;Inherit;False;2;2;0;FLOAT;-0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;20;-1045.517,861.294;Inherit;False;2;2;0;FLOAT;-0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-2014.044,1206.159;Inherit;False;Property;_MovementFadeStart;Movement Fade Start;9;0;Create;True;0;0;0;False;0;False;30;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;38;-1918.044,966.1592;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;39;-1998.044,1126.159;Inherit;False;Property;_MovementFadeEnd;Movement Fade End;10;0;Create;True;0;0;0;False;0;False;60;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-879.9069,867.2406;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-871.0883,674.9717;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CameraDepthFade;40;-1678.044,1062.159;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;23;-688.5886,926.6633;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.4;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-553.8021,922.6992;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.4;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;41;-1416.261,1065.253;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;25;-515.5755,565.9219;Inherit;False;1;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;26;-421.1385,720.5612;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;42;-1256.286,1065.328;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-214.4856,624.5409;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;30;-516.2574,-6.884996;Inherit;True;Property;_NormalTexture;Normal Texture;1;0;Create;True;0;0;0;False;0;False;-1;None;164b81533617247499e86da8845bbcc4;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;31;-514.8852,-196.2788;Inherit;True;Property;_ColorTexture;Color Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;5d93f9a7872434d419a703ec94e2b61b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-180.1863,-326.875;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;34;-480.0649,-393.6496;Inherit;False;Property;_Tint;Tint;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;28;-552.8953,238.8167;Inherit;True;Property;_MaskTexture;Mask Texture;2;0;Create;True;0;0;0;False;0;False;-1;None;c4259520617ece849a1d97357c3a1947;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;36;-774.8523,123.7689;Inherit;False;Property;_Roughness;Roughness;6;0;Create;True;0;0;0;False;0;False;0.23;0.15;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DiffusionProfileNode;33;-451.4328,426.8015;Float;False;Property;_DiffusionProfile;Diffusion Profile;4;0;Create;True;0;0;0;False;0;False;4decbeb3f774a92429e6bc2053c4d42d;0;False;0;1;FLOAT;0
...
WireConnection;0;7;36;0
WireConnection;0;8;28;2
WireConnection;0;9;31;4
WireConnection;0;16;28;3
WireConnection;0;62;33;0
WireConnection;0;11;29;0
ASEEND*/
//CHKSM=61F171352973FAED24D0F8DFE82B55E719FF8B3F